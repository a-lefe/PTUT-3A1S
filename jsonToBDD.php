<?php
// Connexion à la bdd
$pdo = require_once('www/model/connect_mysql.php');
// Récupération des données au format json
$jsondata = file_get_contents('www/all_data.json');
